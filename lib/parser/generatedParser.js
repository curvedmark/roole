...
var generatedParser = module.exports = (function(){
  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_negationArgumentList() {
        var r0, r1, r2, r3, r4, r5, r6, r7;
      ...
      function parse_pseudoArgumentList() {
        var r0, r1, r2, r3, r4, r5, r6, r7;
      ...
      function parse_call() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(value, argumentLists) {
        		var node = value;
      ...
      function parse_identifierStart() {
        ...
        if (r0 === null) {
          ...
          if (r0 === null) {
            ...
            if (r0 !== null) {
              reportedPos = r1;
              r0 = (function(dash, interpolation) {
      ...
      function parse_partialIdentifier() {
        var r0, r1, r2;
        
        r1 = pos;
        r2 = parse_partialRawIdentifier();
        if (r2 === null) {
          r2 = parse_variable();
          if (r2 === null) {
            r2 = parse_interpolation();
          }
        }
        if (r2 !== null) {
          r0 = [];
      ...
      function parse_partialRawIdentifier() {
        var r0, r1, r2;
      ...
      function parse_assignment() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(variable, operator, value) {
      ...
      function parse_module() {
        ...
        r1 = pos;
        r2 = pos;
        if (input.substr(pos, 7).toLowerCase() === "@module") {
          r3 = input.substr(pos, 7);
          pos += 7;
        } else {
          r3 = null;
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(name, separator, ruleList) {
