  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_property() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(star, name, propertyValue) {
        		if (star) {
      ...
      function parse_multiLineList() {
        ...
        if (r3 !== null) {
          ...
          if (r5 !== null) {
            reportedPos = r6;
            r5 = (function(l) {return [N('separator', [',']), l]})(r9);
          }
          if (r5 === null) {
            pos = r6;
          }
      ...
      function parse_postdent() {
        var r0, r1, r2, r3;
        
        r1 = pos;
        r2 = parse_dentsOrSpaces();
        if (r2 !== null) {
          r3 = parse_eof();
          if (r3 !== null) {
            r0 = [r2, r3];
